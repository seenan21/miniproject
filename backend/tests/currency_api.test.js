...
const sequelize = require('../models/db') // Provide a path to your config.js or database.js file, wherever you export that sequelize
...
const Currency = require('../models/testCurrency')
test('Currency model should be defined', () => {
